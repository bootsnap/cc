...
Rails.application.configure do
  ...
  config.action_controller.asset_host = "https://spree-web-d5pu.onrender.com"
  config.action_mailer.default_url_options = "https://spree-web-d5pu.onrender.com"
  config.action_controller.default_url_options = "https://spree-web-d5pu.onrender.com"
